...
void MainDialog::fillInfoLabel()
{
    ...
    if (itCurrentGraphicNode != mNavigatorItemToGraphicNode.end())
    {
        ...
        //--- parent and world transform
        
        oss << "Parent transform:\n" << gn->mParentTransform.toString().toStdString() << "\n";
        oss << "World transform:\n" << gn->mWorldTransform.toString().toStdString() << "\n\n";
        ...
        case IGraphicNode::ntLibrary:
        {
            ...
            {
                oss << ln->mImages[i]->mFilenamePath + "\n";
            }
        }break;
    ...
    mpInfoLabel->setText( QString::fromStdString( oss.str() ) );
}
