...
// extracted from qkeymapper_win.cpp
...
static const uint windowsKey[] = { // Keyboard mapping table
...
char keyMap::toWindowsVkKey( int iQtKeyCode )
{
	char r = 0;
  for( int i = 0; i < 255; ++i )
  { if( windowsKey[i] == iQtKeyCode ) { r = i; break; } }
  return r;
}